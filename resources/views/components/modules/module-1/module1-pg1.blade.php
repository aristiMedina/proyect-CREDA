<x-app-layout auth='{{ $isAuth }}'>
    ...
    <div class="col-md-8 shadow-lg contendorMod mod1">
        <div class="col-md modulo1 m1">
            ...
            <div>
                <button class="buttonModSiguiente"><a class="link-light link-offset-2 link-underline-opacity-0 .d-print-inline-block py-3 px-4" href="{{ route('module-1', ['page'=>2]) }}">Siguiente</a></button>
