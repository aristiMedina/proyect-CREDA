<x-app-layout>
    <div class="row d-flex align-items-center justify-content-center">
        <div class="col-lg-8 text-start bg-main">
            ...
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Aliquid assumenda nisi enim fugiat magnam
                placeat iusto vel sunt debitis et, tempora dignissimos eveniet atque ducimus natus possimus hic,
